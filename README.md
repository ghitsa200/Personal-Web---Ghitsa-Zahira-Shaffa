...
a. Header Judul menampilkan tulisan “Halaman Administrator” dengan latar pink cerah, menciptakan kesan profesional dan konsisten secara visual.

b. Sambutan untuk Admin hadir dengan gaya santai, menyapa admin dan memberi petunjuk singkat penggunaan halaman untuk mengelola data.

c. Panel Statistik menunjukkan jumlah artikel dan galeri secara ringkas, membantu admin memantau data secara cepat tanpa perlu membuka halaman lain.

d. Menu Navigasi Samping berisi tautan ke Beranda, Kelola Artikel, Kelola Gallery, About, dan Logout. Desainnya simpel dengan warna hijau pada Logout agar tampil lebih jelas dari menu lainnya.
...
a. Header Judul ditampilkan di bagian atas halaman dengan teks “// HALAMAN ADMIN //” yang menggunakan huruf kapital dan warna putih, ditempatkan di atas latar belakang berwarna pink cerah. Tampilan ini mempertahankan konsistensi visual dengan halaman admin utama dan memberi kesan tegas namun tetap modern. 

b. Tabel Artikel menyajikan daftar artikel dalam format tabel yang rapi dan informatif. Tabel ini terdiri dari beberapa kolom yaitu nomor, nama artikel, isi artikel, dan aksi. Setiap artikel ditampilkan dalam satu baris lengkap, sehingga admin dapat membaca isi artikel secara langsung tanpa perlu membuka halaman terpisah.
...
<img width="650" alt="kelola galery" src="https://github.com/user-attachments/assets/f0a75c4f-55bd-4ad4-9f21-0a36e947e62b" />

a. Header Judul ditampilkan dengan teks “Kelola Gallery” di bagian atas halaman, menggunakan huruf besar berwarna putih di atas latar belakang pink cerah. Tampilan ini menjaga konsistensi visual dengan halaman admin lainnya, sekaligus memberi penanda yang jelas tentang fungsi halaman.

b. Daftar Gallery ditampilkan dalam bentuk grid dengan gambar-gambar yang telah diunggah sebelumnya. Setiap gambar dilengkapi dengan judul kegiatan di bawahnya, serta dua opsi aksi yaitu Edit dan Hapus. Format ini membuat visualisasi konten lebih menarik dan memudahkan pengelolaan secara langsung dari satu halaman.

c. Tombol Tambah Gambar terletak di pojok kanan atas halaman dan ditampilkan dengan warna pink mencolok agar mudah terlihat. Tombol ini memudahkan admin untuk menambahkan foto baru ke dalam galeri dengan satu klik saja.
...
a. Header Judul berada di bagian atas halaman dengan teks “Kelola Halaman About” berwarna putih di atas latar pink cerah. Gaya judul ini konsisten dengan halaman lainnya dan memberi penekanan pada fungsi halaman secara langsung.

b. Konten Tentang Saya ditampilkan dalam sebuah kotak dengan teks yang menjelaskan profil pribadi. Pada contoh ini, berisi cerita singkat tentang perjalanan akademik dan motivasi Ghitsa Zahira Shaffa sebagai mahasiswa Fakultas Ilmu Komputer, serta pandangannya terhadap dunia teknologi. Penulisan yang personal ini memperkuat kesan bahwa web ini benar-benar merepresentasikan pemiliknya.

c. Tombol Tambah Data berada di pojok kanan atas dan berwarna pink terang. Tombol ini berfungsi untuk menambahkan konten baru ke bagian "Tentang Saya", atau bisa juga dipakai untuk mengganti deskripsi yang ada.
...
a. Form Login terdiri dari dua bidang input, yaitu Username dan Password, yang harus diisi oleh admin sebelum mengakses dashboard. Di bawah form terdapat dua tombol aksi: Login dengan warna merah muda mencolok yang menandakan tindakan utama, dan Cancel berwarna abu-abu untuk membatalkan proses masuk.
...
<img width="650" alt="artikel" src="https://github.com/user-attachments/assets/4b262115-2bcf-4dc0-b73a-87d5cdbb4b56" />

a. Header Navigasi berada di bagian atas dengan judul website “Personal Web | Ghitsa Zahira Shaffa” yang ditampilkan tegas dalam warna putih di atas latar pink cerah. Di bawahnya terdapat menu horizontal: Artikel, Gallery, About, dan Login, yang memudahkan pengunjung berpindah halaman.

b. Artikel Terbaru disusun dalam bentuk list vertikal dengan judul berwarna pink mencolok dan teks isi ringkas di bawahnya. Penulisan artikel dikemas dengan gaya naratif dan informatif, menjadikan halaman ini sebagai ruang berbagi pengalaman, dokumentasi kegiatan, hingga opini penulis.
...
a. Navigasi Utama tersedia dalam bentuk menu horizontal: Artikel, Gallery, About, dan Login, yang memudahkan pengunjung berpindah antar halaman secara cepat dan intuitif.
...
<img width="650" alt="about depan" src="https://github.com/user-attachments/assets/8d1fdecf-cfc6-44fe-9adc-e979c0034975" />

a. Navigasi utama ditata secara horizontal dengan menu: Artikel, Gallery, About, dan Login, memungkinkan pengunjung berpindah halaman dengan mudah.

b. Bagian isi utama berjudul “Tentang Saya” dan menyajikan paragraf naratif yang menjelaskan perjalanan pribadi Ghitsa Zahira Shaffa sebagai mahasiswa Fakultas Ilmu Komputer. Deskripsi ini menggambarkan motivasi, semangat belajar, serta pandangan terhadap teknologi sebagai alat untuk menciptakan solusi dan masa depan yang lebih baik.
